...
public class DashboardView extends View{
    ...
    public CustomArray home(CustomArray response){
        ...
        this.showAlert("Successfully Logged In!", this.textGreen);
    ...
    public CustomArray selectUser(CustomArray response){
        ...
        this.showAlert("Please enter a valid username to message: ", this.textGreen);
    ...
    public CustomArray message(CustomArray response){
        ...
        if(!hasMessages){
            ...
            this.showAlert("no messages, please enter your first message!",this.textYellow);
        }//else skip
