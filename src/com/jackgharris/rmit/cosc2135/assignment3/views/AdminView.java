    ...
    public CustomArray log(CustomArray response){
        ...
        if(logArray.length >1) {
            ...
            while (i < logArray.length) {
                ...
                System.out.println(TextColors.textYellow+"_____________________________________________________");
                System.out.println(logArray[i]+TextColors.reset);
                //increase our counter
                i++;
            }
        }else{
            //else if we have no entires we show no log entries found
            showAlert("No session log entries found",TextColors.textYellow);
        }
